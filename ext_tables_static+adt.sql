UPDATE static_languages SET external_id=1 WHERE lg_iso_2='EN';
UPDATE static_languages SET external_id=2 WHERE lg_iso_2='FR';
UPDATE static_languages SET external_id=3 WHERE lg_iso_2='ES';
