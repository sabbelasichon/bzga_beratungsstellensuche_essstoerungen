...
return array(
    'ctrl' => array(
        'title' => 'LLL:EXT:bzga_beratungsstellensuche_essstoerungen/Resources/Private/Language/locallang_db.xlf:tx_bzgaberatungsstellensuche_domain_model_targetgroup',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath(
            ...
            ).'Resources/Public/Icons/tx_bzgaberatungsstellensuche_domain_model_targetgroup.gif',
        'searchFields' => 'title',
    ),
    'interface' => array(
    ...
    'columns' => array(
        ...
        'l10n_parent' => array(
            ...
            'config' => array(
                ...
                'foreign_table_where' => 'AND tx_bzgaberatungsstellensuche_domain_model_targetgroup.pid=###CURRENT_PID### AND tx_bzgaberatungsstellensuche_domain_model_targetgroup.sys_language_uid IN (-1,0)',
            ),
        ),
