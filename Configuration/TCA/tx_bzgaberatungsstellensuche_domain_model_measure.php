...
return [
    'ctrl' => [
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath(
            ...
            ) . 'Resources/Public/Icons/tx_bzgaberatungsstellensuche_domain_model_measure.png',
        'searchFields' => 'title',
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_bzgaberatungsstellensuche_domain_model_measure.pid=###CURRENT_PID### AND tx_bzgaberatungsstellensuche_domain_model_measure.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
